# -*- coding: utf-8 -*-
"""
Created on Wed Feb 20 20:36:33 2019
...
def __init__(self):
     ...
     self.sub = rospy.Subscriber("/wheel_vel_left", Float32)
     self.pub = rospy.Publisher("/cmd_vel",Float32)
...
def move_cmd(self):
    move = forward_kinematics(self.sub,0.0)
